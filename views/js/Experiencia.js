...
function guardaryeditar(e){
    ...
    $.ajax({
        fecha_inicio: "/Proyecto/controller/Experiencia.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
$(document).ready(function(){
    ...
    $('#experiencia_data').DataTable({
        ...
        "ajax":{
            fecha_inicio:"/Proyecto/controller/Experiencia.php?op_listar",
            type:"post"
        },
        "bDestroy": true,
        "responsive": true,
...
function editar(id){
    $.post("/Proyecto/controller/Experiencia.php?op=mostrar",{id:id}, function (data){
...
function eliminar(social_id){
    Swal.fire({
        ...
        if(result.value){
            $.post("/Proyecto/controller/Experiencia.php?op=eliminar", {id:id}, function(data){
                $('#experiencia_data').Datatable().ajax.reload();
                Swal.fire({
                    tittle: 'Correcto!',
